...
public class RemoveCustomerFrame extends JInternalFrame {
	private static final long serialVersionUID = 8051494727193089732L;

	public RemoveCustomerFrame() throws ParseException {
		super("Remover Cliente", true, true, true, true);
		initialize();
		pack();
	}
	...
	private void initialize() throws ParseException {
		...
		JButton btn_removeCustomer = new JButton("Remover");
		getContentPane().add(btn_removeCustomer, "cell 5 1,growx,aligny bottom");
		btn_removeCustomer.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					ChameleonFantasies.facade.removeWrongAdditions(cpf, 0);
