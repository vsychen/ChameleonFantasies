...
public class SeeCustomerFrame extends JInternalFrame {
	private static final long serialVersionUID = 221250838781701605L;

	public SeeCustomerFrame() throws ParseException {
		super("Procurar Cliente", true, true, true, true);
		initialize();
		pack();
	}
	...
	private void initialize() throws ParseException {
		...
		JButton btn_seeCustomer = new JButton("Procurar");
		getContentPane().add(btn_seeCustomer, "cell 5 1,growx,aligny bottom");
		btn_seeCustomer.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					String str = ChameleonFantasies.facade.seeCustomer(cpf).toString();
