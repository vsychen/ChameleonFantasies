...
public class ReportEmployeeFrame extends JInternalFrame {
	private static final long serialVersionUID = -3310618719117882409L;

	public ReportEmployeeFrame() throws ParseException {
		super("Listar Funcionários", true, true, true, true);
		initialize();
		pack();
	}
	...
	private void initialize() throws ParseException {
		...
		JButton btn_reportEmployees = new JButton("Listar");
		getContentPane().add(btn_reportEmployees, "cell 6 10,growx,aligny bottom");
		btn_reportEmployees.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					panel.removeAll();

					String str = ChameleonFantasies.facade.getReport(1);
