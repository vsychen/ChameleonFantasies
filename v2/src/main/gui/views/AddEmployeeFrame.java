...
public class AddEmployeeFrame extends JInternalFrame {
	private static final long serialVersionUID = 775494338753129297L;

	public AddEmployeeFrame() throws ParseException {
		super("Cadastrar Funcionário", true, true, true, true);
		initialize();
		pack();
	}
	...
	private void initialize() throws ParseException {
		...
		getContentPane().add(lbl_job, "cell 1 7,alignx right,aligny center");
		JTextField tf_job = new JTextField();
		getContentPane().add(tf_job, "cell 3 7,growx,aligny center");
		...
		JButton btn_addEmployee = new JButton("Cadastrar");
		getContentPane().add(btn_addEmployee, "cell 8 8,growx,aligny bottom");
		btn_addEmployee.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					ChameleonFantasies.facade.addEmployee(name, cpf, email, street, city, state, country, job, salary);
